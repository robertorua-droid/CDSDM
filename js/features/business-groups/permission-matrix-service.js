...
(function () {
  ...
  const MODULE_CATALOG = [
    ...
    { id: 'reports', label: 'Report e simulazioni', category: 'Analisi', scope: 'reports', targets: ['statistiche','report-gestionali','simulazione-ordinario','simulazione-lm'], description: 'Dashboard, report gestionali e simulazioni fiscali.' },
