...
(function () {
        ...
        <div class="modal-body"><form id="supplierDdtForm" onsubmit="return false;">
          ...
          <div class="card mb-3"><div class="card-header fw-semibold">Righe DDT</div><div class="card-body">
            <div class="row g-2 align-items-end" id="supplierDdt-manualLineControls">
              ...
              <div class="col-md-2"><label class="form-label">Ricevuta</label><input class="form-control text-end" id="supplierDdt-lineReceivedQty" type="number" min="0" step="0.001" value="1" /></div>
              <div class="col-md-2"><label class="form-label">Accettata</label><input class="form-control text-end" id="supplierDdt-lineAcceptedQty" type="number" min="0" step="0.001" value="1" /></div>
              <div class="col-md-2"><label class="form-label">Quarantena</label><input class="form-control text-end" id="supplierDdt-lineQuarantineQty" type="number" min="0" step="0.001" value="0" /></div>
              <div class="col-md-2"><label class="form-label">Respinta</label><input class="form-control text-end" id="supplierDdt-lineRejectedQty" type="number" min="0" step="0.001" value="0" /></div>
  ...
  function recalcLines() {
    ...
    tempLines.forEach(function(l,i){
      ...
      $body.append('<tr><td>'+esc(lineOrigin(l))+'</td><td>'+esc(l.productCode||'')+'</td><td>'+esc(l.productDescription||'')+'</td><td>'+esc(l.unitOfMeasure||'pz')+'</td><td class="text-end">'+(l.sourceOrderId ? fmtQty(l.remainingSourceQty) : '-')+'</td><td><input class="form-control form-control-sm text-end supplier-ddt-line-field" data-field="receivedQty" data-index="'+i+'" type="number" min="0" step="0.001" value="'+esc(num(l.receivedQty))+'"'+maxAttr+'></td><td><input class="form-control form-control-sm text-end supplier-ddt-line-field" data-field="acceptedQty" data-index="'+i+'" type="number" min="0" step="0.001" value="'+esc(num(l.acceptedQty))+'"></td><td><input class="form-control form-control-sm text-end supplier-ddt-line-field" data-field="quarantineQty" data-index="'+i+'" type="number" min="0" step="0.001" value="'+esc(num(l.quarantineQty))+'"></td><td><input class="form-control form-control-sm text-end supplier-ddt-line-field" data-field="rejectedQty" data-index="'+i+'" type="number" min="0" step="0.001" value="'+esc(num(l.rejectedQty))+'"></td><td class="text-end">'+fmtMoney(l.price)+'</td><td>'+esc(l.notes||'')+'</td><td class="text-end"><button class="btn btn-sm btn-outline-danger supplier-ddt-remove-line" data-index="'+i+'" type="button"'+removeDisabled+'><i class="fas fa-trash"></i></button></td></tr>');
    });
  }
