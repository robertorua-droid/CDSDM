...
(function () {
  ...
  function renderDataUsagePage() {
    ...
    const items = [
      ...
      { label: 'Segnalazioni operative', value: (getData('operationalReports') || []) },
  ...
  function _normalizeBackup(raw) {
    ...
    return {
      ...
      operationalReports: Array.isArray(r.operationalReports) ? r.operationalReports : [],
  ...
  async function _importBackupNormalized(backup) {
    ...
    const collections = [
      ...
      ['operationalReports', backup.operationalReports],
    ...
    $('#export-cloud-json-btn').on('click', async function () {
      try {
        ...
        const backup = {
          ...
          operationalReports: globalData.operationalReports || [],
