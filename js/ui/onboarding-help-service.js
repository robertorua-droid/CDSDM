...
(function(){
  ...
  const HELP = {
    home: {
      ...
      manualAnchor: 'manuale-capitolo-primi-passi'
    },
    preventivi: {
      ...
      manualAnchor: 'manuale-capitolo-vendite'
    },
    'ordini-cliente': {
    ...
    'ordini-fornitore': {
      ...
      manualAnchor: 'manuale-capitolo-acquisti'
    },
    'ddt-fornitore': {
    ...
    'workflow-approvativi': {
      ...
      manualAnchor: 'manuale-capitolo-workflow'
    },
    'operational-reports': {
      ...
      manualAnchor: 'manuale-capitolo-segnalazioni'
    },
    'mini-bi': {
      ...
      manualAnchor: 'manuale-capitolo-mini-bi'
    },
    'magazzino-quarantena': {
      ...
      manualAnchor: 'manuale-capitolo-magazzino'
    },
    scadenziario: {
      title: 'Scadenziario',
      ...
      manualAnchor: 'manuale-capitolo-contabilita'
    },
    avanzate: {
      title: 'Gestione dati',
      ...
      manualAnchor: 'manuale-capitolo-backup'
    },
    'audit-sicurezza': {
      ...
      manualAnchor: 'manuale-capitolo-permessi'
    }
  };
  ...
  function renderHelp(h){
    return '<div class="cdsdm-help-card-inner">'
      ...
      + '<div class="mt-2"><a href="#" class="small cdsdm-help-open-manual" data-manual-anchor="' + escapeHtml(h.manualAnchor || '') + '">Apri capitolo collegato del Manuale utente</a></div>'
      + '</div>';
  }
  ...
  function openManual(anchor){
    ...
    if(targetAnchor){ window.CDSDM_MANUAL_TARGET_ANCHOR = targetAnchor; }
    const link = document.querySelector('.sidebar .nav-link[data-target="manuale"]');
    if(link) link.click();
    else if(targetAnchor){ window.location.hash = targetAnchor; }
  }
  ...
  document.addEventListener('click', function(e){
    ...
    if(manual){ e.preventDefault(); openManual(manual.getAttribute('data-manual-anchor') || ''); }
  });

  function manualAnchorFor(sectionId){ return getHelp(sectionId).manualAnchor || ''; }
  window.OnboardingHelpService = { VERSION, HELP, DEFAULT, getHelp, messageFor, manualAnchorFor, renderHelp, enhanceSection, refresh, decorateVisibleSection, openManual, init };
