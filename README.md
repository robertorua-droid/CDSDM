...
### 0.13.15 — Coerenza menu documenti commerciali
...
- Backup JSON aggiornato a `appVersion: 0.13.15`.
...
### 0.13.15 — Rifinitura branding logo trasparente
...
- Aggiornati documentazione, test branding e backup JSON a `appVersion: 0.13.15`.


### 0.13.15 — Rifinitura branding logo con cilindro ocra
...
### 0.13.15 — Integrazione build del logo approvato
...
### 0.13.15 — Hotfix registrazione con invito
...
### 0.13.15 — Chiarezza membri e profili permesso senza override
...
### 0.13.15 — Hotfix Firestore compatibilità permessi
...
### 0.13.15 — Hotfix profili permesso e ruolo informativo

- Corretto `Profili permesso`: la lista ruoli ora gestisce correttamente `BusinessGroupsService.ROLES` come oggetto o array.
