## CDSDM Versione 0.13.11 — Hotfix registrazione con invito
La versione **0.13.11** corregge il flusso di registrazione con invito: il collaboratore non tenta più di leggere il documento root del Gruppo aziendale prima di essere membro, evitando l’errore Firestore `Missing or insufficient permissions`. Non introduce nuovi flussi, collezioni o regole Firestore.
...
### 0.13.11 — Coerenza menu documenti commerciali
...
- Backup JSON aggiornato a `appVersion: 0.13.11`.
...
### 0.13.11 — Rifinitura branding logo trasparente
...
- Aggiornati documentazione, test branding e backup JSON a `appVersion: 0.13.11`.


### 0.13.11 — Rifinitura branding logo con cilindro ocra
...
### 0.13.11 — Integrazione build del logo approvato
...
### 0.13.11 — Inviti collaboratore responsive
...
- Aggiornati documentazione, test e backup JSON a `appVersion: 0.13.11`.


### 0.13.11 — Hotfix registrazione con invito
